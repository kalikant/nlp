...
stop_words.extend(['data', 'info','javascript', 'java', 'css','site','bookmarks','bookmark'])

import glob
import errno

path = '/Users/kalikantjha/PycharmProjects/ACLBOT/venv/us_re/web_data/*.jl'
...
data = df.page_data.values.tolist()
...
# Convert to list
complete_data = df.page_data.values.tolist()
